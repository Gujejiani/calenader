...
import {  ChangeDetectorRef, ElementRef, Injectable, QueryList, ViewChildren, effect } from "@angular/core";
...
export abstract class CalendarBaseClass {
    ...
    onCellClick<K extends keyof CalendarEvent | string>(
      ...
      this.calendarService.updateWeekCalendar(columnName as keyof CalendarEvent, row, this.editingText);
